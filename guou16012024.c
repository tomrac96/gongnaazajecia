...
void no_to_gramy(plansza,plansza,plansza,plansza,plansza*,legal);
...
plansza bakapik(plansza*);
legal czy_legal(plansza,ruch,plansza,plansza,plansza,plansza*);
legal ko(plansza,plansza*);
legal samobuj(plansza,ruch,plansza,plansza,plansza);
plansza nyet_bakapik(plansza*);
...
void main(){
    ...
    plansza backup;      //tu wpisuje ulozenie planszy z przed 2 ruchow
    bakapik(&backup);
    
    no_to_gramy(teatr_wojenny,niby_zbite,zbadane,do_zbicia,&backup,zgoda);
    nyet_bakapik(&backup);
}

void no_to_gramy(plansza teatr_wojenny,plansza niby_zbity,plansza zbadane,plansza do_zbicia,plansza *backup,legal zgoda){

    //vanish(&backup);vanish(&backup->next);vanish(&backup->prev);//vanish(&backup->prev->prev);
    ...
    teatr_wojenny.ruch_gracza_X=RUCH_CZARNY; //Gracz zaczynajacy
     numerek++;
        ...
        do{
            ...
            /*++++++++++*/backup=&plac_boju; /*++++++++++*/
            zgoda=czy_legal(teatr_wojenny,staruszek1,zbadane,niby_zbity,do_zbicia,&backup);
    ...
    teatr_wojenny=plac_boju;
    wypisz(&plac_boju);
    backup->next=&plac_boju;

    backup->prev=backup->next;
    //===================================================================================
