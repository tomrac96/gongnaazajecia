...
void no_to_gramy(plansza,plansza,plansza,plansza,plansza);
...
void main(){
    ...
    no_to_gramy(teatr_wojenny,niby_zbite,zbadane,do_zbicia);
}

void no_to_gramy(plansza teatr_wojenny,plansza niby_zbity,plansza zbadane,plansza do_zbicia,plansza backup){
    int pomocnik;
    int qniec=0;
    int numerek=0;
