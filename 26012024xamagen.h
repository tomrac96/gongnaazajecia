...
int negamax(plansza* p, int glebokosc, plansza zbadane,plansza niby_zbite,plansza do_zbicia,castorama *historia)
{
    return xamagen(p, glebokosc, -10, 10,zbadane,niby_zbite,do_zbicia,historia);
}
#endif
