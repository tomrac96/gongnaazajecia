...
void czy_legal(plansza teatr_wojenny,ruch gruch,plansza zbadane,plansza niby_zbite,plansza do_zbicia ){
    legal czy_mozna;
    legal mozna;
    czy_mozna=samobuj(teatr_wojenny,gruch,zbadane,niby_zbite,do_zbicia,mozna);
    if(czy_mozna.czy_legalne==L)
        czy_mozna=ko(teatr_wojenny);
}

legal samobuj(plansza teatr_wojenny,ruch gruch,plansza zbadane,plansza niby_zbite,plansza do_zbicia, legal mozna){
...
legal ko(plansza teatr_wojenny){
   
}
/* W fukncji ko zamierzam uzyc listy dwukier lun jednokier w celu siegniecia do ukladu z planszy z przed 2 ruchow aby zoabczyc czy nie zostanie popelnione ko
*/
